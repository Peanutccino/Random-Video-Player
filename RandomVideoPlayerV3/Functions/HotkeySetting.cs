...
namespace RandomVideoPlayer.Functions
{
    ...
    public static class HotkeyManager
    {
        ...
        public static HotkeySettings GetDefaultHotkeySettings()
        {
            return new HotkeySettings
            {
                Hotkeys = new List<HotkeySetting>
                {
                    ...
                    new HotkeySetting { Action = "AddRemoveCurrentToList", Key = Keys.Delete, Modifiers = Keys.Alt },
                    ...
                    new HotkeySetting { Action = "ToggleTimer", Key = Keys.T, Modifiers = Keys.None },
                    ...
                    new HotkeySetting { Action = "StatisticsOverlayPage0", Key = Keys.D0, Modifiers = Keys.Control },
                    new HotkeySetting { Action = "StatisticsOverlayPage1", Key = Keys.D1, Modifiers = Keys.Control },
                    new HotkeySetting { Action = "StatisticsOverlayPage2", Key = Keys.D2, Modifiers = Keys.Control },
                    new HotkeySetting { Action = "StatisticsOverlayPage3", Key = Keys.D3, Modifiers = Keys.Control },
                    new HotkeySetting { Action = "StatisticsOverlayPage4", Key = Keys.D4, Modifiers = Keys.Control },
                    new HotkeySetting { Action = "StatisticsOverlayPage5", Key = Keys.D5, Modifiers = Keys.Control },
                    ...
                    new HotkeySetting { Action = "SeekRandom", Key = Keys.Up, Modifiers = Keys.Alt },
        ...
        public static HotkeySettings LoadHotkeySettings()
        {
            ...
            {
                Error.Log(ex, "Failed to load hotkeySettings", LogLevel.Error);
                return defaultSettings;
            }
        ...
        public static void SaveHotkeySettings(HotkeySettings settings)
        {
            ...
            {
                Error.Log(ex, "Couldn't save hotkeys.json", LogLevel.Error);
            }
